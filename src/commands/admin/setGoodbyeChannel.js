...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await db.collection('config').doc('channels').set({ goodbyeChannelId: channel.id }, { merge: true });
        await interaction.reply({ content: `✅ Salon de départ défini sur <#${channel.id}>.`, ephemeral: true });
    },
};
